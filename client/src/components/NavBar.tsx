...
const NavBar = () => {
    ...
    const handleRedirect = (destination: string, RESTtype: string) => {
      setRequestType(RESTtype);
    ...
    return(
        <nav className= "md lg relative w-full flex flex-wrap items-center justify-left py-4 bg-gray-100 shadow-lg sticky top-0">
          ...
          <p onClick={() => handleRedirect("/add", "POST")} className="ml-6 text-gray-500 hover:text-gray-600 focus:text-gray-600">Add Shift</a>
