...
from .views import AddScheduleViewSet, DeleteScheduleViewSet, ShiftsViewSet, DateViewSet, MondayViewSet, TuesdayViewSet, WednesdayViewSet, ThursdayViewSet, FridayViewSet, SaturdayViewSet, SundayViewSet
